...
from flux_context_pipeline_clip import FluxContextImg2ImgPipeline
...
def main(args):
    ...
    #text_encoder_two = load_text_encoders(text_encoder_cls_two)
    ...
    def compute_text_embeddings(prompt_2, text_encoders, tokenizers):
        with torch.no_grad():
    ...
    if accelerator.is_main_process:
        tracker_name = "dreambooth-flux-txt2img"
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(models_to_accumulate):
              ...
              #  ] * len(pixel_values)
                ...
                pooled_image_embeds = compute_image_embeddings(garment_image)

                # Los embeddings del T5 solamente
